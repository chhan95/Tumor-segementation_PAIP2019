...
root_path = 'D:/'
original_4_image_path = root_path + '4_PAIP_original_patch/'
original_image_path = root_path + 'PAIP_original_patch/'
tumor_abs_path = 'D:/new_4_label/'
for i in range(1, 21):

    if not os.path.exists('D:/new_4_label/Training_phase_1_{0:03d}_whole_label'.format(i)):
        os.mkdir('D:/new_4_label/Training_phase_1_{0:03d}_whole_label'.format(i))
    if not os.path.exists('D:/new_4/Training_phase_1_{0:03d}'.format(i)):
        os.mkdir('D:/new_4/Training_phase_1_{0:03d}'.format(i))
    ...
    file_list = glob.glob(original_4_image_path + 'Training_phase_1_{0:03d}/*.jpg'.format(i))
    ...
    for file in file_list:
        ...
        path = 'D:/new_4/Training_phase_1_{0:03d}'.format(
        ...
        cv2.imwrite(
            tumor_abs_path + 'Training_phase_1_{0:03d}_whole_label'.format(i) +
