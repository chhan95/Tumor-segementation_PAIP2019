...
for i in range(21, 51):
    ...
    if not os.path.exists('D:/wrong_patch_original/Training_phase_2_{0:03d}'.format(i) + '_whole_label'):
        os.mkdir('D:/wrong_patch_original/Training_phase_2_{0:03d}'.format(i) + '_whole_label')
    if not os.path.exists('D:/wrong_patch_original/Training_phase_2_{0:03d}'.format(i) + '_viable_label'):
        os.mkdir('D:/wrong_patch_original/Training_phase_2_{0:03d}'.format(i) + '_viable_label')
    if not os.path.exists('D:/wrong_patch_original/Training_phase_2_{0:03d}'.format(i)):
        os.mkdir('D:/wrong_patch_original/Training_phase_2_{0:03d}'.format(i))
        ...
        for k in range(label_w):
            if wrong_tumor_matrix[j, k] == 1 or wrong_viable_matrix[j, k] == 1:
                ...
                if t_img.shape == (1024, 1024):
                    ...
                    path = 'D:/wrong_patch_original/Training_phase_2_{0:03d}'.format(
